...
#ifndef _DLINKEDLIST_HEADTAIL_H_
#define _DLINKEDLIST_HEADTAIL_H_
...
extern my_bool dlinked_list_is_empty(const DLinkedList L);
...
extern void dlinked_list_print(const DLinkedList L, const char *format, void (*elem_print)(FILE *, const void *));
extern void dlinked_list_free(DLinkedList *DLP);
extern linked_list_size_type dlinked_list_length(const DLinkedList L);
...
extern linked_list_index_type dlinked_list_right_search(const DLinkedList L, const void *elem, int (*elem_cmp)(const void *, const void *));
extern linked_list_index_type dlinked_list_left_search(const DLinkedList L, const void *elem, int (*elem_cmp)(const void *, const void *));
extern my_bool dlinked_list_contains(const DLinkedList L, void *elem, int (*elem_cmp)(const void *, const void *));
...
extern DLinkedList dlinked_list_slice(DLinkedList L, linked_list_index_type left, linked_list_index_type right, linked_list_index_type step);
