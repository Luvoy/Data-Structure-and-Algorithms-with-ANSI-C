#include "linked_list_withhead_test.h"
#include <time.h>
#include <assert.h>
#include <stdio.h>
...
void linked_list_withhead_test_1(void)
{
    ...
    /* scanf("%d", &n); */
    n = 6;
    LinkedList L1 = linked_list_new(n);

    LinkedList L2 = linked_list_new_from_args(8,
                                              p_data_2[0], p_data_2[1], p_data_2[2], p_data_2[3],
                                              p_data_2[4], p_data_2[5], p_data_2[6], p_data_2[7]);

    LinkedList L3 = linked_list_new_from_elements(p_data_3, 12);

    LinkedList L4 = linked_list_new_from_elements(NULL, 0);
    ...
    LinkedList L5 = linked_list_new_from_elements(NULL, 0);
